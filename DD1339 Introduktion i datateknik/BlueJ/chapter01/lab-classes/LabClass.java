...
public class LabClass
{
     ...
     */
    public LabClass(int maxNumberOfPerson)
    {
        instructor = "unknown";
        room = "unknown";
        timeAndDay = "unknown";
        persons = new ArrayList<Person>();
        capacity = maxNumberOfPerson;
    }

    /**
     * Add a student to this LabClass.
     */
    public void enrollPerson(Person newPerson)
    {
    ...
    public void printList()
    {
        ...
        //    person.print();
        //}
        System.out.println("Number of students: " + numberOfPersons());
    }
}
