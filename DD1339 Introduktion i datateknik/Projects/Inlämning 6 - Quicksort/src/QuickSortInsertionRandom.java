/**
 * the class for Quicksort with Insertionsort and random pivot
 * 
...
public class QuickSortInsertionRandom implements IntSorter {
	...
	private void qsort(int[] v, int first, int last) {
	    ...
	    int p = v[first + randint.nextInt(last-first)];
